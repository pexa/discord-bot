...
// exports.commands = ['cp', 'market', 'price']
        ...
        for (var x = 0; x < response.body.length; x++) {
          ...
          if (myObj.symbol.toUpperCase() === symbol.toUpperCase()) {
            ...
            if (myObj.market_cap_usd != null) {
              myObj.market_cap_usd = parseFloat(myObj.market_cap_usd.toString())
                .toFixed(2)
                .toString()
            ...
            if (arr[6] != null) {
              arr[6] = parseFloat(arr[6].toString())
                .toFixed(2)
                .toString()
                .replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,')
            }
            ...
            data =
              ...
              myObj.rank +
              ' \nMarket Cap : $ ' +
              myObj.market_cap_usd +
              ' \nCirculating Units: ' +
              myObj.available_supply +
              ' \nTrading Volume: $ ' +
              arr[6]
            price_change =
              '1 Hour:  ' +
              myObj.percent_change_1h +
              ' \n1 Day:    ' +
              myObj.percent_change_24h +
              ' \n1 Week: ' +
              myObj.percent_change_7d
            thumbnail =
              'https://files.coinmarketcap.com/static/img/coins/200x200/' +
              myObj.id +
              '.png'
...
// exports.price = {
//   usage: '',
//   description: 'Check Pexa Coin price.',
//   process: function(bot, msg, suffix) {
//     let embed
//     let symbol = 'pexa'
//     let author = ''
...
exports.market = {
  usage: '',
  description: 'See all Pexa Coin buy/sell orders.',
  process: function(bot, msg, suffix) {
    let embed
